...
/***/ "./src/factories/boardNodeFactory.js":
/*!*******************************************!*\
  !*** ./src/factories/boardNodeFactory.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar boardNodeFactory = function boardNodeFactory(x, y) {\n  var coordinates = [x, y];\n  var containsShipPart = false;\n  var isHit = false;\n  var element = null;\n  var renderNode = function renderNode() {\n    var el = document.createElement('div');\n    el.className = \"w-full h-full bg-blue-400 hover:bg-blue-500 border border-blue-800 rounded-sm transition transform hover:-translate-y-0.5\";\n    element = el;\n  };\n  var hasShip = function hasShip() {\n    return containsShipPart;\n  };\n  var setNodeContainsShipPart = function setNodeContainsShipPart() {\n    var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;\n    return containsShipPart = value;\n  };\n  var recieveAttack = function recieveAttack() {\n    isHit = true;\n    if (element) {\n      element.className = containsShipPart ? \"bg-red-500\" : \"bg-gray-400\";\n    }\n    ;\n    return containsShipPart ? \"hit\" : \"miss\";\n  };\n  return {\n    hasShip: hasShip,\n    setNodeContainsShipPart: setNodeContainsShipPart,\n    recieveAttack: recieveAttack,\n    renderNode: renderNode,\n    getCoordinates: function getCoordinates() {\n      return coordinates;\n    },\n    getElement: function getElement() {\n      return element;\n    },\n    getHitState: function getHitState() {\n      return isHit;\n    }\n  };\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (boardNodeFactory);\n\n//# sourceURL=webpack://battleship-odin/./src/factories/boardNodeFactory.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _boardNodeFactory__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./boardNodeFactory */ \"./src/factories/boardNodeFactory.js\");\n/* harmony import */ var _helpers_hashCell__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/hashCell */ \"./src/helpers/hashCell.js\");\nfunction _createForOfIteratorHelper(r, e) { var t = \"undefined\" != typeof Symbol && r[Symbol.iterator] || r[\"@@iterator\"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && \"number\" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t[\"return\"] || t[\"return\"](); } finally { if (u) throw o; } } }; }\nfunction _unsupportedIterableToArray(r, a) { if (r) { if (\"string\" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return \"Object\" === t && r.constructor && (t = r.constructor.name), \"Map\" === t || \"Set\" === t ? Array.from(r) : \"Arguments\" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }\nfunction _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }\n\n\nvar gameBoardFactory = function gameBoardFactory() {\n  var _boardNodes = new Map();\n  var _SIZE = 10;\n  var _gameBoardElement = document.querySelector('#gameboard');\n  var _isBoardInit = false;\n  var initialiseNodes = function initialiseNodes() {\n    for (var i = 1; i <= _SIZE; i++) {\n      for (var j = 1; j <= _SIZE; j++) {\n        var newCell = (0,_boardNodeFactory__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(i, j);\n        _boardNodes.set((0,_helpers_hashCell__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(i, j), newCell);\n      }\n      ;\n    }\n    ;\n    _isBoardInit = true;\n  };\n  var getNode = function getNode(x, y) {\n    if (x === null || x === undefined || y === null || y === undefined) throw new Error(\"Invalid coordinates given: Received \".concat(x, \", \").concat(y));\n    if (isNaN(x) || isNaN(y)) throw new Error(\"Invalid coordinates given: Received \".concat(x, \", \").concat(y));\n    return _boardNodes.get((0,_helpers_hashCell__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(x, y)) || null;\n  };\n  var renderNodes = function renderNodes() {\n    var _iterator = _createForOfIteratorHelper(_boardNodes.values()),\n      _step;\n    try {\n      for (_iterator.s(); !(_step = _iterator.n()).done;) {\n        var node = _step.value;\n        node.renderNode();\n      }\n    } catch (err) {\n      _iterator.e(err);\n    } finally {\n      _iterator.f();\n    }\n  };\n  var renderBoard = function renderBoard() {\n    var _iterator2 = _createForOfIteratorHelper(_boardNodes.values()),\n      _step2;\n    try {\n      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {\n        var node = _step2.value;\n        var nodeElement = node.getElement();\n        _gameBoardElement.append(nodeElement);\n      }\n    } catch (err) {\n      _iterator2.e(err);\n    } finally {\n      _iterator2.f();\n    }\n    ;\n  };\n  return {\n    initialiseNodes: initialiseNodes,\n    renderBoard: renderBoard,\n    renderNodes: renderNodes,\n    getNode: getNode,\n    getGameBoard: function getGameBoard() {\n      return new Map(_boardNodes);\n    },\n    getBoardElement: function getBoardElement() {\n      return _gameBoardElement;\n    },\n    isInit: function isInit() {\n      return _isBoardInit;\n    }\n  };\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (gameBoardFactory);\n\n//# sourceURL=webpack://battleship-odin/./src/factories/gameBoardFactory.js?");

/***/ }),

/***/ "./src/helpers/hashCell.js":
/*!*********************************!*\
  !*** ./src/helpers/hashCell.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar hashCell = function hashCell(x, y) {\n  if (x === undefined || y === undefined) throw new Error(\"Invalid coordinates given. Expect (x, y), Received \".concat(x, \", \").concat(y));\n  if (x === null || y === null) throw new Error(\"Invalid coordinates given. Expect (x, y), Received \".concat(x, \", \").concat(y));\n  return \"\".concat(x, \", \").concat(y);\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (hashCell);\n\n//# sourceURL=webpack://battleship-odin/./src/helpers/hashCell.js?");
